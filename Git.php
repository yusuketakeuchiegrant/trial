...
class Git {
    ...
    public static function &clone_remote($repo_path, $remote, $reference = null) {
        // Changed the below boolean from true to false, since this appears to be a bug when not using a reference repo.
        // A more robust solution may be appropriate to make it work with AND without a reference.
